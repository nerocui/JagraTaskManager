    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DependerId = table.Column<string>(nullable: false),
                    DependeeId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketDependencies", x => new { x.DependeeId, x.DependerId });
                    table.ForeignKey(
                        name: "FK_TicketDependencies_Tickets_DependeeId",
                        column: x => x.DependeeId,
                        principalTable: "Tickets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TicketDependencies_Tickets_DependerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketStatuses", x => new { x.TicketId, x.StatusId });
                    table.ForeignKey(
                        name: "FK_TicketStatuses_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketWatches", x => new { x.UserId, x.TicketId });
                    table.ForeignKey(
                        name: "FK_TicketWatches_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketWatches_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyToId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketDependencies_DependerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketStatuses_StatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketWatches_TicketId",
                table: "TicketWatches",
                column: "TicketId");
        }
